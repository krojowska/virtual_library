...
<main>
    ...
    <h1 class="text-center" style="color:white">Edytuj <span style="color: #2CBFA4;">książkę</span></h1>
    <br/>
    <form class="text-center" action="edytowanie.php" method="post">
        Id: <br/> <input type="text" name="id"/> <br/><br/>
        Tytuł: <br/> <input type="text" name="tytul"/> <br/><br/>
        Autor: <br/> <input type="text" name="autor"/> <br/><br/>
        Data wydania: <br/> <input type="text" name="datawydania"/> <br/><br/>
        Ilość sztuk: <br/> <input type="text" name="iloscsztuk"/> <br/><br/>
        <input class="przycisk" type="submit" value="Edytuj"/>
    </form>
